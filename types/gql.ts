...
export type ThingLogTypePayload =
  | ThingSensorEnergyType
  | ThingStateType
  | ThingStateFourSwitchType
  | ThingSensorTemperatureType;
...
export type ThingStateType = ThingState &
  ThingPowerModuleState & {
...
export type ThingStateFourSwitchType = ThingStateFourSwitch &
  ThingState & {
...
export type Unnamed_1_Query = { __typename?: 'Query' } & {
  cams: Array<
    { __typename?: 'CameraType' } & Pick<CameraType, 'id' | 'name' | 'channel'>
  >;
  userOrganization: { __typename?: 'UserType' } & Pick<
    UserType,
    'id' | 'first_name' | 'last_name' | 'email'
  > & {
      organization?: Maybe<
        { __typename?: 'OrganizationType' } & Pick<
          OrganizationType,
          'id' | 'name'
        > & {
            sites?: Maybe<
              Array<
                { __typename?: 'SiteType' } & Pick<SiteType, 'id' | 'name'> & {
                    floors?: Maybe<
                      Array<
                        { __typename?: 'FloorType' } & Pick<
                          FloorType,
                          'id' | 'name'
                        >
                      >
